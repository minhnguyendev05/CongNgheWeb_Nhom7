        ...
        <div class="col-12">
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="index.php?action=editCategory&id=<?php echo $category['id']; ?>">
                        <div class="row">
                            <div class="col-12 mb-4">
                                <label for="name" class="form-label fw-semibold">Category Name</label>
                                <input type="text" class="form-control rounded-pill" id="name" name="name" value="<?php echo htmlspecialchars($category['name']); ?>" placeholder="Enter category name" required>
                            </div>
                            <div class="col-12 mb-4">
                                <label for="description" class="form-label fw-semibold">Description</label>
                                <textarea class="form-control rounded-4" id="description" name="description" rows="4" placeholder="Describe the category purpose"><?php echo htmlspecialchars($category['description']); ?></textarea>
                            </div>
                        </div>
